...
public class MusicFavouriteFragment extends Fragment implements OnStartDragListener, OnPlaylistItemListChangedListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter.setType(PlaylistConstants.TYPE_MUSIC_FAVOURITE);
    ...
    private void setUpRecyclerView(){
        ...
        mItemTouchHelper.attachToRecyclerView(binding.rcvMusicFavourite);
    ...
    private void setDisplayModeAsGrid() {
        binding.rcvMusicFavourite.setHasFixedSize(true);
